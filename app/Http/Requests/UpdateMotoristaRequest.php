...
class UpdateMotoristaRequest extends FormRequest
{
    ...
    {
        return [
            'nome_motorista' => 'sometimes|required|string|max:100',
            'cpf_motorista' => 'sometimes|required|string|size:11|unique:motoristas,cpf_motorista,' . $this->route('motorista')->id,
            'data_nascimento_motorista' => 'sometimes|required|date',
