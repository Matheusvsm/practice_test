...
class UpdateCaminhaoRequest extends FormRequest
{
    ...
    {
        return [
            'placa_caminhao' => 'sometimes|required|string|max:8|unique:caminhoes,placa_caminhao,' . $this->route('caminhao')->id,
            'modelo_caminhao' => 'sometimes|required|string|max:50',
            'cor_caminhao' => 'sometimes|required|string|max:50',
